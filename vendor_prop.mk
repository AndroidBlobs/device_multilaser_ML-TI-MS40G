PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    ro.boot.hardware.revision=mut_br-V1 \
    ...
    ro.config.default_message0=Ceres_48k.ogg \
    ro.config.default_message1=Ceres_48k.ogg \
    ro.config.default_message=Ceres_48k.ogg \
    ro.config.low_ram=true \
    ro.config.notification_sound=Ceres_48k.ogg \
    ro.config.ringtone0=Atria.ogg \
    ro.config.ringtone1=Atria.ogg \
    ro.config.ringtone=Atria.ogg \
    ro.config.ringtone_2=Atria.ogg \
    ro.control_privapp_permissions=log \
    ro.custom.build.version=ML-TI05-MS40G.V15_20191014 \
    ro.feature.storage.dialog=true \
    ro.ge2.mode=gps_beidou \
    ro.hardware.keystore=sprdtrusty \
    ro.hotspot.enabled=1 \
    ro.internal.build.version=K101AG_8.1_MUT_BR_GMS_33 \
    ro.keybox.id.value=Multilaser_MS40G \
